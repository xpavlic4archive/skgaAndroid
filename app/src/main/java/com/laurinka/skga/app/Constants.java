...
public interface Constants {
    ...
    String SKGA_HCP_PREFIX = SKGA_PREFIX + "HCP";
    String SKGA_NAME_PREFIX = SKGA_PREFIX + "NAME";
    String SKGA_CLUB_PREFIX = SKGA_PREFIX + "CLUB";
    
    String CGF_HCP_PREFIX = CGF_PREFIX + "HCP";
    String CGF_NAME_PREFIX = CGF_PREFIX + "NAME";
    String CGF_CLUB_PREFIX = CGF_PREFIX + "CLUB";
